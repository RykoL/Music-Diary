...
<form method='post' id={formId}>
    <div class="form-control">
        ...
        <input type="text" id="title" name="title" class="input input-bordered w-full" placeholder="Title"
               required value={entry.title} on:change={hasChanged}>
    </div>
    <div class="form-control">
        ...
        <input type="url" id="song" name="song" class="input input-bordered w-full"
               ...
               value="{entry.songURL}" required on:change={hasChanged}>
    ...
    <div class="form-control">
        ...
        <textarea id="content" name="content" class="textarea textarea-bordered h-24"
                  placeholder="Any text you wanna share additionally" on:change={hasChanged}>{entry.content}</textarea>
    </div>
    <div class="form-control">
