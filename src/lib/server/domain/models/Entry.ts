...
import {AttachedImage, type Image, ImageId, UnattachedImage} from "$lib/server/domain/models/Image";
...
export class Entry {
    ...
    constructor(id: EntryId, diaryId: DiaryId, title: EntryTitle, images: Array<Image>, content: string, song: Song, date: Date) {
        this.id = id
        this.title = title
        this.images = images
        this.song = song
